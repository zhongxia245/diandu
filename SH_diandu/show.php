  ...
  <div id="container" class="m-bgs page-swipe">
    ...
    <header class="diandu__header">
      ...
      <div class="diandu__header--center">
        <img v-if="hasGlobalAudio" @click="handleOpenAudio" src="./imgs/mods/header/global_audio.png" alt="全程音频">
      </div>
      <div class="diandu__header--right" @click="handleOpenPageList">
        <img src="./imgs/mods/header/icon_pages.png" alt="点读页列表">
      </div>
    </header>
    <!--header END-->
    ...
    <mt-popup :modal="false" v-cloak v-model="popup_audioplayer"  position="bottom" style="width:101%; height:25%;">
      <div class="audio-player" @click="handleAudioPlayerClick">
