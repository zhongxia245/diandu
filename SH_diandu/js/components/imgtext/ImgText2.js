...
var ImgText = function (selector, data, fn_submit) {
	...
	this.submit = function () {
		...
		that.data['content'] = ''
		if (that.editor && that.editor.html()) {
			that.data['content'] = encodeURIComponent(that.editor.html())
		}
	...
	this.set = function (data) {
		...
		if (that.editor && data['content']) {
			that.editor.html(decodeURIComponent(data['content']))
		}
