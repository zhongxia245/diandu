...
var ImgText = function (selector, data, fn_upload, fn_submit, setUploadify, basePath) {
    ...
    this.tpl = [
        ...
        '          <div class="upload-imgtext-upload">',
        '             <input class="upload-input" type="file" id="upload-imgtext-{{id}}" name="upload" class="fileupload"/>',
        '          </div>',
        '          <span class="upload-imgtext-info"> +图片 </span>',
