...
var ExamCreate = function (selector, data, fn_submit) {
  ...
  this.tpl = [
    ...
    '    <img data-type="radio" src="../imgs/exam/exam_type_radio.png" alt="单选" title="单选">',
    '    <img data-type="checkbox" src="../imgs/exam/exam_type_checkbox.png" alt="多选" title="多选">',
    '    <img data-type="bool" src="../imgs/exam/exam_type_bool.png" alt="对错" title="对错">',
    '  </div>',
    '  <!--题型选择 END-->',
    '  <!--顶部工具栏 START-->',
